...
/** A dependency parser node in the CONLL-X format, namely,
...
public class ConllDependencyNode extends Annotation {
  ...
  /** getter for id - gets The token's position in the sentence. The ROOT node,
  ...
  /** setter for id - sets The token's position in the sentence. The ROOT node,
						present in every dependency parse, has id=0. 
   * @generated */
