...
/** A Penn Treebank-style tree node. Conforms to PTB 2.0
				guidelines.
...
public class TreebankNode extends Annotation {
  ...
  /** getter for headIndex - gets The head index tracks the index into the word tokens
  ...
  /** setter for headIndex - sets The head index tracks the index into the word tokens
						which is the syntactic head of a phrase. 
   * @generated */
